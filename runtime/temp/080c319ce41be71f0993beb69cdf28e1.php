<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:45:"template/admin\b2c\Wchat\oneKeySubscribe.html";i:1495020459;s:28:"template/admin\b2c\base.html";i:1495424696;s:34:"template/admin\b2c\openDialog.html";i:1495424452;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<!-- 				<h1><a href="#" title="<?php echo $title_name; ?>"><span>NIU</span>SHOP&nbsp;<span>电商系统</span></a></h1> -->
 ...
 <!--加载弹层代码-->
    <!--big title end-->
    <input type="hidden" id="link" value="<?php echo $one_key_url['url']; ?>">
    <div class="main">
      <div style="background: #FCF8E3;width: 780px;margin-left:65px;padding: 10px;border:1px solid #eee;">
        ...
        <input id="urlInput" value="<?php echo $one_key_url['url']; ?>" type="text" class="form-control input-xxlarge" placeholder="粘贴微信公众平台图文素材网址" style="border-radius: 3px;width: 450px;">
