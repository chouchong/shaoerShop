<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"template/admin\b2c\Config\webConfig.html";i:1495420006;s:28:"template/admin\b2c\base.html";i:1495424696;s:34:"template/admin\b2c\openDialog.html";i:1495424452;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>网站标题:</dt>
		<dd>
			<input id="title" type="text" value="<?php echo $website['title']; ?>" />
		</dd>
	</dl>
	<dl>
		<dt>官方网址:</dt>
		<dd>
			<input id="web_url" type="text" value="<?php echo $website['web_url']; ?>" />
		</dd>
	</dl>
	<dl>
		<dt>联系地址:</dt>
		<dd>
			<input id="web_address" type="text" value="<?php echo $website['web_address']; ?>" />
		</dd>
	</dl>
	<dl>
		<dt>网站二维码:</dt>
	...
	<dl>
		...
		<dd>
			<textarea name="store_zy" rows="2" id="web_desc"
				class="textarea w400" maxlength="50"><?php echo $website['web_desc']; ?></textarea>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="key_words" type="text" value="<?php echo $website['key_words']; ?>" />
			</p>
	...
	<dl>
		...
		<dd>
			<p>
				<input id="web_phone" type="text" value="<?php echo $website['web_phone']; ?>" />
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<input id="web_email" type="text" value="<?php echo $website['web_email']; ?>" />
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<input id="web_qq" type="text" value="<?php echo $website['web_qq']; ?>" />
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<input id="web_weixin" type="text" value="<?php echo $website['web_weixin']; ?>" />
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<input id="web_icp" type="text" value="<?php echo $website['web_icp']; ?>" />
			</p>
		</dd>
	</dl>
	<dl>
		...
		<dd>
			<p>
				<select id="style_id"> <?php if(is_array($style_list) || $style_list instanceof \think\Collection || $style_list instanceof \think\Paginator): $i = 0; $__LIST__ = $style_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
