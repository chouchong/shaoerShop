<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"template/admin\b2c\Config\loginConfig.html";i:1494403272;s:28:"template/admin\b2c\base.html";i:1495424696;s:34:"template/admin\b2c\openDialog.html";i:1495424452;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
...
<div class="set-style">
	<dl>
		<dt>APP_KEY:</dt>
		<dd><input name="" id="APP_KEY" type="text" value="<?php echo $qq_config['oauth_value']['APP_KEY']; ?>"/></dd>
	</dl>
	<dl>
		<dt>APP_SECRET:</dt>
		<dd><input name="" id="APP_SECRET" type="text" value="<?php echo $qq_config['oauth_value']['APP_SECRET']; ?>"/></dd>
	</dl>
	<dl>
		<dt>是否启用:</dt>
		<dd>
	...
	<dl>
		<dt>申请域名:</dt>
		<dd><?php echo $qq_config['oauth_value']['AUTHORIZE']; ?></dd>
	</dl>
	<dl>
		<dt>回调域名:</dt>
		<dd><?php echo $qq_config['oauth_value']['CALLBACK']; ?></dd>
	</dl>
	<input type = "hidden" id="AUTHORIZE" value="<?php echo $qq_config['oauth_value']['AUTHORIZE']; ?>">	
	<input type = "hidden" id="CALLBACK" value="<?php echo $qq_config['oauth_value']['CALLBACK']; ?>">
...
<div class="set-style">
	<dl>
		<dt>APP_KEY:</dt>
		<dd><input name="" id="APP_KEY" type="text" value="<?php echo $wchat_config['oauth_value']['APP_KEY']; ?>"/></dd>
	</dl>
	<dl>
		<dt>APP_SECRET:</dt>
		<dd><input name="" id="APP_SECRET" type="text" value="<?php echo $wchat_config['oauth_value']['APP_SECRET']; ?>"/></dd>
	</dl>
	<dl>
		<dt>是否启用:</dt>
		<dd>
	...
	<dl>
		<dt>申请域名:</dt>
		<dd><?php echo $wchat_config['oauth_value']['AUTHORIZE']; ?></dd>
	</dl>
	<dl>
		<dt>回调域名:</dt>
		<dd><?php echo $wchat_config['oauth_value']['CALLBACK']; ?></dd>
	</dl>
	<input type = "hidden" id="AUTHORIZE" value="<?php echo $wchat_config['oauth_value']['AUTHORIZE']; ?>">
	<input type = "hidden" id="CALLBACK" value="<?php echo $wchat_config['oauth_value']['CALLBACK']; ?>">
	<button class="edit_button" onclick="setConfigAjax();">提交</button>
</div>
<script>
	function setConfigAjax(){
