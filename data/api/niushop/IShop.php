...
interface IShop
{
     ...
     * @param unknown $sort            
     */
    function addShopNavigation($nav_title, $nav_url, $type, $sort, $align);
     ...
     * @param unknown $sort            
     */
    function updateShopNavigation($nav_id, $nav_title, $nav_url, $type, $sort, $align);
     ...
     */
    function updateShopConfigByshop($shop_id, $shop_logo, $shop_banner, $shop_avatar, $shop_qq, $shop_ww, $shop_phone, $shop_keywords, $shop_description);
