...
interface IPromote
{
    ...
    */
    function addCouponType($coupon_name, $money, $count, $max_fetch, $at_least, $need_user_level, $range_type, $start_time, $end_time, $goods_list);
    /**
     * 修改优惠券类型
     * @param unknown $data
    */
    function updateCouponType($coupon_id, $coupon_name, $money, $count, $max_fetch, $at_least, $need_user_level, $range_type, $start_time, $end_time, $goods_list);
    /**
     * 获取店铺积分配置信息
     */
