...
class PayParam extends BaseService
{
    ...
    protected function getParam($instance){
        ...
        $this->pay_appid = $wchat_config['oauth_value']['appid'];
        $this->pay_appsecret = $wchat_config['oauth_value']['appkey'];
        $this->pay_mchid = $wchat_config['oauth_value']['mch_id'];
        $this->pay_mchkey = $wchat_config['oauth_value']['mch_key'];
        //获取支付宝支付参数(统一支付到平台账户)
        $alipay_config = $config->getAlipayConfig($instance);
        $this->ali_partnerid = $alipay_config['oauth_value']['ali_partnerid'];
        $this->ali_seller = $alipay_config['oauth_value']['ali_seller'];
        $this->ali_key = $alipay_config['oauth_value']['ali_key'];
