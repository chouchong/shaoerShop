...
use data\model\niushop\NsCouponModel;
use data\service\niushop\Promote;
use data\service\BaseService;
use data\service\niushop\Goods;
use data\service\niushop\Member\MemberCoupon;
use data\model\niushop\NsCouponGoodsModel;
use data\model\niushop\NsCouponTypeModel;
...
class GoodsPreference extends BaseService{
    ...
    public function getGoodsSkuPrice($sku_id)
    {
     ...
     /*    $goods = new NsGoodsModel();
        $goods_info = $goods->getInfo(['goods_id' => $goods_sku_info['goods_id']], 'point_exchange_type');
   
        $promote_info = $this->getGoodsPromote($goods_sku_info['goods_id']);
     ...
     * 获取商品列表总积分
     * @param unknown $goods_sku_list
     * @return Ambigous <\data\service\niushop\promotion\Ambigous, number, unknown>
     */
