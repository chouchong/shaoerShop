...
use data\api\niushop\IShop;
use data\model\niushop\NsShopAdModel as NsShopAdModel;
use data\model\niushop\NsShopNavigationModel as NsShopNavigationModel;
use data\model\niushop\NsShopModel as NsShopModel;
use data\model\niushop\NsShopGroupModel as NsShopGroupModel;
...
use data\model\system\AuthGroupModel;
use data\model\niushop\NsOrderModel;
use think;
use data\model\niushop\NsShopWeixinShareModel;
use data\model\niushop\NsShopAccountModel;
use data\model\niushop\NsShopAccountRecordsModel;
use data\service\niushop\Order as OrderService;
use data\model\niushop\NsShopWithdrawModel;
use data\model\niushop\NsShopBankAccountModel;
use data\service\niushop\shopaccount\ShopAccount as ShopAccountService;
...
use data\model\niushop\NsShopOrderGoodsReturnModel;
use data\model\niushop\NsMemberWithdrawSettingModel;
use data\model\niushop\NsRewardRuleModel;
use data\model\system\ProvinceModel;
use data\model\system\CityModel;
use data\model\system\DistrictModel;
use data\service\system\Album;
...
class Shop extends BaseService implements IShop
{
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IConfig::getShopAdList()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IConfig::addShopAd()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IConfig::updateShopAd()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\niushop\IShop::addShopNavigation()
     */
    public function addShopNavigation($nav_title, $nav_url, $type, $sort, $align)
    {
     ...
     * @see \data\api\niushop\IShop::addShopNavigation()
     */
    public function updateShopNavigation($nav_id, $nav_title, $nav_url, $type, $sort, $align)
    {
        $shop_navigation = new NsShopNavigationModel();
        $data = array(
            'nav_title' => $nav_title,
     ...
     * {@inheritdoc}
     *
     * @see \data\api\niushop\IShop::delShopNavigation()
     */
    public function delShopNavigation($nav_id)
    {
        $shop_navigation = new NsShopNavigationModel();
        $retval = $shop_navigation->destroy([
            'nav_id' => $nav_id
        ]);
        return $retval;
    }
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::ShopNavigationList()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::shopNavigationDetail()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::modifyShopNavigationSort()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::dealwithShopApply()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::getShopGroupDetail()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\niushop\IShop::getShopApplyDetail()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::getShopTypeDetail()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\niushop\IShop::updateShopConfigByshop()
     */
    public function updateShopConfigByshop($shop_id, $shop_logo, $shop_banner, $shop_avatar, $shop_qq, $shop_ww, $shop_phone, $shop_keywords, $shop_description)
    {
        $data = array(
            'shop_logo' => $shop_logo,
     ...
     * {@inheritdoc}
     *
     * @see \data\api\niushop\IShop::updateShopConfigByPlatform()
     */
     ...
     * 用户店铺消费(non-PHPdoc)
     *
     * @see \data\api\niushop\IOrder::getShopUserConsume()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::updateShopShareCinfig()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\niushop\IShop::getShopShareConfig()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopAccountList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopCommissionWithdrawList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopBankAccountList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::addShopBankAccount()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::updateShopBankAccount()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::modifyShopBankAccountIsdefault()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::deleteShopBankAccouht()
     */
     ...
     * 店铺申请提现
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::applyShopCommissionWithdraw()
     */
     ...
     * 店铺提现审核
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::shopAccountWithdrawAudit()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopAccountCountList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopAccountRecordsList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopOrderAccountRecordsList()
     */
    public function getShopOrderAccountRecordsList($page_index, $page_size = 0, $condition = '', $order = '')
    {
        $shop_order_goods_return = new NsShopOrderGoodsReturnModel();
        $return = $shop_order_goods_return->pageQuery($page_index, $page_size, $condition, $order, '*');
        foreach ($return["data"] as $k => $v) {
            $order_goods = new NsOrderGoodsModel();
            $order_goods_info = $order_goods->getInfo(array(
                "order_goods_id" => $v["order_goods_id"]
            ), "*");
            $return["data"][$k]["order_goods_info"] = $order_goods_info;
        }
        return $return;
    }
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopAccountRecordCount()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopAccountSales()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopGoodsSales()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\niushop\IShop::getShopWithdrawCount()
     */
