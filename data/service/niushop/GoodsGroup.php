...
use data\api\niushop\IGoodsGroup as IGoodsGroup;
use data\model\niushop\NsGoodsModel;
class GoodsGroup extends BaseService implements IGoodsGroup{
	...
	/* (non-PHPdoc)
     * @see \data\api\niushop\IGoodsGroup::getGoodsGroupList()
     */
	...
	/* (non-PHPdoc)
     * @see \data\api\niushop\IGoodsGroup::addOrEditGoodsGroup()
     */
	...
	/* (non-PHPdoc)
     * @see \data\api\niushop\IGoodsGroup::deleteGoodsGroup()
     */
    public function deleteGoodsGroup($goods_group_id_array, $shop_id)
    {
        ...
        if (! empty($sub_list)) {
            ...
            $res = $this->goods_group->destroy($goods_group_id_array);
        }
        return $res;
        // TODO Auto-generated method stub
    ...
    /**
     * (non-PHPdoc)
     * @see \data\api\niushop\IGoodsGroup::getGoodsGroupListByParentId()
     */
    ...
    */
    ...
    /**
     * (non-PHPdoc)
     * @see \data\api\niushop\IGoodsGroup::getGroupGoodsTree()
     */
