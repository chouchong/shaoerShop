...
use data\api\system\IWeixinMessage;
...
class WeixinMessage extends BaseService implements IWeixinMessage
{
    ...
    private function sendMessage($instance_id, $openid, $templateId, $url, $first, $keyword1, $keyword2, $keyword3, $keyword4, $remark)
    {
        if(isWeixin())
        {
            if (NS_VERSION == NS_VER_B2C || NS_VERSION == NS_VER_B2C_FX) {
                ...
                $wchat_auth = new WeixinAuthModel();
                $auth_info = $wchat_auth->getInfo([
                    'instance_id' => $instance_id
                ], '*');
                if (! empty($auth_info)) {
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::getWeixinInstanceMsg()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::updateWeixinInstanceMessage()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::getWeixinMsgTemplate()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::sendWeixinOrderCreateMessage()
     */
...
//         }
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::sendWeixinOrderPayMessage()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::sendWeixinOrderDeliverMessage()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::sendWeixinOrderRefundMessage()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixinMessage::sendWeixinOrderRefundApply()
     */
