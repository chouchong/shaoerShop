...
use data\api\system\IAuthGroup as IAuthGroup;
...
class AuthGroup extends BaseService implements IAuthGroup
{
    ...
    */
    ...
    /**
     * {@inheritDoc}
     * @see \data\api\system\IAuthGroup::getSystemUserGroupDetail()
     */
    public function getSystemUserGroupDetail($group_id){
        return $this->authgroup->get($group_id);
    }
	/* (non-PHPdoc)
     * @see \data\api\system\IAuthGroup::getSystemUserGroupAll()
     */
