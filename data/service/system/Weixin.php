...
use data\api\system\IWeixin;
use data\model\system\WeixinMenuModel;
use data\model\system\WeixinAuthModel;
use data\model\system\WeixinFansModel;
use data\model\system\WeixinFollowReplayModel;
use data\model\system\WeixinDefaultReplayModel;
use data\model\system\WeixinKeyReplayModel;
use data\model\system\WeixinMediaModel;
use data\model\system\WeixinMediaItemModel;
use data\extend\WchatOauth;
use data\model\system\WeixinQrcodeConfigModel;
use data\model\system\WeixinQrcodeTemplateModel;
use data\model\system\WeixinInstanceMsgModel;
use data\model\niufenxiao\NfxShopMemberAssociationModel;
use data\model\system\WeixinOneKeySubscribeModel;
use data\service\niushop\Shop;
use data\model\system\UserModel;
use data\model\system\WeixinUserMsgModel;
use data\model\system\WeixinUserMsgReplayModel;
use think\Model;
...
class Weixin extends BaseService implements IWeixin
{
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinMenuList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addWeixinMenu()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::updateWeixinMenu()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::updateWeixinMenuSort()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::updateWeixinMenuName()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::updateWeixinMenuUrl()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::updateWeixinMenuEventType()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::updateWeiXinMenuMessage()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addMenuHits()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinMenuDetail()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addWeixinAuth()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addWeixinFans()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addFollowReplay()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::updateFollowReplay()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addKeyReplay()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::updateKeyReplay()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getKeyReplayList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getFollowReplayList()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::getDefaultReplayList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinFansList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinAuthList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addWeixinMedia()
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::addWeixinMediaItem()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinMediaList()
     */
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinMediaDetail()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::getWeixinMediaDetailByMediaId()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getShopidByAuthorAppid()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getWeixinUidByOpenid()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getWeixinInfoByAppid()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::WeixinUserUnsubscribe()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getInstanceWchatMenu()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::updateInstanceMenuToWeixin()
     */
     ...
     *
     * @see \data\api\system\IWeixin::getMediaWchatStruct()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::getDefaultReplay()
     */
     ...
     * 获取会员 微信公众号二维码
     *
     * @see \data\api\system\IUser::getUserWchatQrcode()
     */
    public function getUserWchatQrcode($uid, $instance_id)
    {
        if (NS_VERSION == NS_VER_B2C || NS_VERSION == NS_VER_B2C_FX) {
            ...
            $auth_info = $this->getWeixinAuthInfo($instance_id);
            if (empty($auth_info)) {
                return WEIXIN_AUTH_ERROR;
            }
            $weixin_auth = new WchatOauth($auth_info['authorizer_appid']);
        }
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::getWeixinQrcodeConfig()
     */
    public function getWeixinQrcodeConfig($instance_id, $uid)
    {
        if (NS_VERSION == NS_VER_B2C) {
            ...
            $shop_member_model = new NfxShopMemberAssociationModel();
            // 得到用户在当前店铺设置的推广二维码
            $shop_member_Obj = $shop_member_model->getInfo([
                "shop_id" => $instance_id,
                "uid" => $uid
            ], "qrcode_template_id");
            $qrcode_template_id = $shop_member_Obj["qrcode_template_id"];
        }
    ...
    /*
     * (non-PHPdoc)
     * @see \data\api\system\IWeixin::updateWeixinQrcodeConfig()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::updateWeixinMedia()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::deleteWeixinMedia()
     */
    public function deleteWeixinMedia($media_id)
    {
        $res = 0;
        $weixin_media_item = new WeixinMediaItemModel();
        $res = $weixin_media_item->destroy([
            'media_id' => $media_id
        ]);
        $weixin_media = new WeixinMediaModel();
        $res += $weixin_media->destroy($media_id);
        return $res;
    }
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::deleteWeixinMenu()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::getFollowReplayDetail()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::getDefaultReplayDetail()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::deleteFollowReplay()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::deleteDefaultReplay()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::getKeyReplyDetail($id)
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::deleteKeyReplay()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::getWeixinQrcodeTemplate()
     */
     ...
     * {@inheritdoc}
     *
     * @see \data\api\system\IWeixin::modifyWeixinQrcodeTemplateValid()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::addWeixinQrcodeTemplate()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::updateWeixinQrcodeTemplate()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::deleteWeixinQrcodeTemplate()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getDetailWeixinQrcodeTemplate()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::updateMemberQrcodeTemplate()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getInstanceOneKeySubscribe()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::setInsanceOneKeySubscribe()
     */
     ...
     * (non-PHPdoc)
     *
     * @see \data\api\system\IWeixin::getUserOpenid()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::getWeixinFansCount()
     */
     ...
     * 
     * @see \data\api\system\IWeixin::getUserWeixinSubscribeData()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::addUserMessage()
     */
     ...
     * (non-PHPdoc)
     * 
     * @see \data\api\system\IWeixin::addUserMessageReplay()
     */
