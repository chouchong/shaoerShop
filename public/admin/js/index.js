var orderChartsTitle = '<span class="charts-title" onclick="onloadOrderChart(1)">今日</span>';
orderChartsTitle += '<span class="charts-title black" onclick="onloadOrderChart(2)">昨日</span>';
orderChartsTitle += '<span class="charts-title black" onclick="onloadOrderChart(3)">本周</span>';
orderChartsTitle += '<span class="charts-title black" onclick="onloadOrderChart(4)">本月</span>';
//orderChartsTitle += '<span class="charts-title-ordernum">订单总数<i>0</i></span>';

var weixinChartsTitle = '<span class="charts-title" onclick="onloadWeiXinFansChart(1)">今日</span>';
weixinChartsTitle += '<span class="charts-title black" onclick="onloadWeiXinFansChart(2)">昨日</span>';
weixinChartsTitle += '<span class="charts-title black" onclick="onloadWeiXinFansChart(3)">本周</span>';
weixinChartsTitle += '<span class="charts-title black" onclick="onloadWeiXinFansChart(4)">本月</span>';
...
function onloadOrderChart(e) {
	...
	$(".charts-title").addClass('black');
	$(".charts-title").eq(e-1).removeClass('black');
	$.ajax({
		type : "post",
